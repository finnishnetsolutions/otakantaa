...
from otakantaa.utils import render_email_template
...
class Action(models.Model, ActionTypeMixin):
    ...
    ROLE_CONTENT_FOLLOWER = 'content-follower'
...
class NotificationQuerySet(models.QuerySet):
    ...
    def get_recipients(self):
        return set([notification.recipient for notification in
                    self.select_related('recipient')])
