...
class UsersListAuthorizedAccessTest(TestCase):
    ...
    def test_moderator(self):
        ...
        self.assertEqual(resp.status_code, 200)
        self.assertTemplateUsed(resp, "okadmin/users_list.html")
...
class UsersListSearchTest(TestCase):
    ...
    def setUp(self):
        ...
        AdminSettings.objects.create(user=user_1, organization=organization_1)
        AdminSettings.objects.create(user=user_2, organization=organization_1)
        AdminSettings.objects.create(user=user_2, organization=organization_2)
        AdminSettings.objects.create(user=user_3, organization=organization_2)
...
class UsersListOrderTest(TestCase):
    ...
    def setUp(self):
        ...
        organization_1 = Organization.objects.create(name="Helsingin koulu", type=1)
        organization_2 = Organization.objects.create(name="Turun koulu", type=1)
        AdminSettings.objects.create(user=self.user_1, organization=organization_1)
        AdminSettings.objects.create(user=self.user_2, organization=organization_1)
        AdminSettings.objects.create(user=self.user_2, organization=organization_2)
        AdminSettings.objects.create(user=self.user_3, organization=organization_2)
...
class UsersEditUnauthorizedAccessTest(TestCase):
    ...
    def test_anonymous_redirect(self):
        resp = self.client.get(reverse("okadmin:users_edit", args=[self.target_user.pk]),
                               follow=True)
...
class UsersEditAuthorizedAccessTest(TestCase):
    ...
    def test_moderator_self(self):
        ...
        self.assertEqual(resp.status_code, 200)
        self.assertTemplateUsed(resp, "okadmin/edit_user.html")
